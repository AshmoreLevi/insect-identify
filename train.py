...
def process_arguments():
    ...
    parser.add_argument('--arch',
                       action='store',
                       dest='choosen_archi', default='resnet50',
                       help='Choosen models to train chicken')
    
    parser.add_argument('--learning_rate',
                       action='store',
                       dest='learning_rate', type=float, default=0.0006,#改
    ...
    parser.add_argument('--epochs',
                       action='store',
                       dest='epochs', type=int, default=12,#改
...
def main():
    ...
    model = mu.set_model_classifier(model, input_arguments.hidden_units, input_size, output_size=15, dropout=0.1)
    ...
    checkpoint_file_path = os.path.join(input_arguments.save_directory, choosen_architecture+"_102improve"+str(input_arguments.epochs)+".pth")
